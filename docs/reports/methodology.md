...
The current implementation and interpretation contract is documented in `docs/methodology.md`.
The copied July 2026 audit under `analysis/case_studies/orcacast/history/` is historical provenance and
must not be used as the current module map or test status.
